<div x-data="{ open: true }" :class="{'w-64': open, 'w-20': !open}" x-transition.duration.300ms class="bg-gray-800 text-white h-full p-5 transition-all duration-300 lg:fixed lg:top-0 lg:left-0 lg:h-screen z-10">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <h2 x-show="open" class="text-xl font-bold">Siswa Panel</h2>
        </div>
        <!-- Toggle Sidebar -->
    ...
    <ul class="mt-10 space-y-5">
        <li>
            <a href="{{ route('siswa.materi.index') }}" class="flex items-center py-2 px-4 hover:bg-gray-700 transition-all rounded-lg">
        ...
        <li>
            <a href="{{ route('siswa.absensi.index') }}" class="flex items-center py-2 px-4 hover:bg-gray-700 transition-all rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                ...
                <span :class="{'block': open, 'hidden': !open}" class="ml-2 text-sm">Presensi</span>
            </a>
        </li>
        <li>
            <a href="{{ route('siswa.kehadiran.index') }}" class="flex items-center py-2 px-4 hover:bg-gray-700 transition-all rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
