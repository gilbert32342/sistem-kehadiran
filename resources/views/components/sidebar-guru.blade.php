<div x-data="{ open: true }" :class="{'w-64': open, 'w-20': !open}" x-transition.duration.300ms class="bg-gray-800 text-white h-full p-5 transition-all duration-300 lg:fixed lg:top-0 lg:left-0 lg:h-screen z-10">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <h2 x-show="open" class="text-xl font-bold">guru Panel</h2>
        </div>
        <!-- Toggle Sidebar -->
    ...
    <ul class="mt-10 space-y-5">
        <li>
            <a href="{{ route('guru.materi.index') }}" class="flex items-center py-2 px-4 hover:bg-gray-700 transition-all rounded-lg">
        ...
        <li>
            <a href="{{ route('guru.absensi.index') }}" class="flex items-center py-2 px-4 hover:bg-gray-700 transition-all rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                ...
                <span :class="{'block': open, 'hidden': !open}" class="ml-2 text-sm">Presensi Guru</span>
            </a>
        </li>
        <li>
            <a href="{{ route('guru.absensi.siswa') }}" class="flex items-center py-2 px-4 hover:bg-gray-700 transition-all rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                    <path d="M21 12c0 4.97-4.03 9-9 9s-9-4.03-9-9 4.03-9 9 9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"/>
                </svg>
                <span :class="{'block': open, 'hidden': !open}" class="ml-2 text-sm">Presensi Siswa</span>
            </a>
        </li>
        <li>
            <a href="{{ route('guru.kehadiran.index') }}" class="flex items-center py-2 px-4 hover:bg-gray-700 transition-all rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                ...
                <span :class="{'block': open, 'hidden': !open}" class="ml-2 text-sm">Riwayat Kehadiran Siswa</span>
            </a>
        </li>
        <li>
            <a href="{{ route('guru.kehadiran.guru') }}" class="flex items-center py-2 px-4 hover:bg-gray-700 transition-all rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                    <path d="M12 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zM1 12c0-5.52 4.48-10 10-10s10 4.48 10 10-4.48 10-10-4.48-10-10 4.48-10 10-10z"/>
                </svg>
